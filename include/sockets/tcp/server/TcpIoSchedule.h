 ...
 * =====================================================================================
 */
#ifndef TCP_SERVER_TCPIOSCHEDULE_H
#define TCP_SERVER_TCPIOSCHEDULE_H
...
public:
    ...
    virtual bool preStart(int acceptThreadNumber = ONE, int recvThreadNumber = TWO) = 0;
    virtual bool start(TcpIoRequest *request, int type = SOCK_STREAM, int protocol = 0) = 0;
    ...
    virtual bool getRequestServer(TcpIoRequest **request, int serverFd) = 0;
...
#endif // TCP_SERVER_TCPIOSCHEDULE_H
