 ...
 * =====================================================================================
 */
#ifndef UDP_CLIENT_UDPIOSCHEDULEIMPL_H
#define UDP_CLIENT_UDPIOSCHEDULEIMPL_H
...
private:
    ...
    UdpIoRequest                        * mRequest;

};  // UdpIoScheduleImpl
};  // udpclient

#endif // UDP_CLIENT_UDPIOSCHEDULEIMPL_H
